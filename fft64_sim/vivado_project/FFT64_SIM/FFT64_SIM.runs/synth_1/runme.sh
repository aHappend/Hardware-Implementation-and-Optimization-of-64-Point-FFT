...
HD_PWD='C:/Users/Happend Outerwall/NJUlocal/fft64_sim/vivado_project/FFT64_SIM/FFT64_SIM.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fft64_dit_sdf.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fft64_dit_sdf.tcl

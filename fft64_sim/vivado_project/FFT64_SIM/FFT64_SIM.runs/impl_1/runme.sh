...
HD_PWD='C:/Users/Happend Outerwall/NJUlocal/fft64_sim/vivado_project/FFT64_SIM/FFT64_SIM.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fft64_dit_sdf.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fft64_dit_sdf.tcl -notrace
